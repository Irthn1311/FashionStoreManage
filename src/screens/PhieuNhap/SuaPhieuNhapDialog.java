...
public class SuaPhieuNhapDialog extends JDialog {
    ...
    public SuaPhieuNhapDialog(Frame parent, PhieuNhapDTO phieuNhap) {
        ...
        add(new JLabel("Tên SP:")); tfTenSP = new JTextField(phieuNhap.getTenSanPham()); add(tfTenSP);
        ...
        add(new JLabel("Thời gian:")); tfThoiGian = new JTextField(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(phieuNhap.getThoiGian())); add(tfThoiGian);
