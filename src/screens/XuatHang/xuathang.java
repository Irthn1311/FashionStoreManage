...
public class xuathang extends javax.swing.JPanel {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                try {
                    ...
                    if (cbMaKhachHang.getSelectedItem() == null) {
                        JOptionPane.showMessageDialog(xuathang.this, "Vui lòng chọn khách hàng.", "Thiếu thông tin",
                    ...
                    if (xuatHangListProcessing.isEmpty()) {
                        JOptionPane.showMessageDialog(xuathang.this,
                                "Không có sản phẩm nào trong phiếu xuất để xác nhận.", "Thông báo",
                    ...
                    if (selectedKhachHang == null) {
                        JOptionPane.showMessageDialog(xuathang.this,
                                "Không tìm thấy thông tin khách hàng: " + currentMaKhachHang, "Lỗi",
                    ...
                    if (dialogResult == JOptionPane.OK_OPTION) {
                        ...
                        if (pdfSelected) {
                            ...
                            String defaultFileName = "HoaDon_" + selectedKhachHang.getMaKhachHang() + "_"
                                    + System.currentTimeMillis() + ".pdf";
                            fileChooser.setSelectedFile(new File(defaultFileName));
                            fileChooser.setFileFilter(
                                    new javax.swing.filechooser.FileNameExtensionFilter("PDF Documents", "pdf"));

                            int userSelection = fileChooser.showSaveDialog(xuathang.this);
                            if (userSelection == JFileChooser.APPROVE_OPTION) {
                                generatedPdfFile = fileChooser.getSelectedFile();
                                boolean pdfGenSuccess = utils.PdfService.generateInvoicePdf(xuatHangListProcessing,
                                        selectedKhachHang, generatedPdfFile.getAbsolutePath());
                                if (pdfGenSuccess) {
                                    JOptionPane.showMessageDialog(xuathang.this,
                                            "Xuất hóa đơn PDF thành công!\nĐã lưu tại: "
                                                    + generatedPdfFile.getAbsolutePath(),
                                            "Thành công PDF", JOptionPane.INFORMATION_MESSAGE);
                                } else {
                                    JOptionPane.showMessageDialog(xuathang.this, "Xuất hóa đơn PDF thất bại!",
                                            "Lỗi PDF", JOptionPane.ERROR_MESSAGE);
                        ...
                        if (emailSelected && allAuxiliaryTasksSucceeded) {
                            boolean emailSendSuccess = utils.EmailService.sendInvoiceByEmail(selectedKhachHang,
                                    xuatHangListProcessing, pdfSelected ? generatedPdfFile : null);
                            if (emailSendSuccess) {
                                JOptionPane.showMessageDialog(xuathang.this,
                                        "Gửi email hóa đơn thành công đến " + selectedKhachHang.getEmail(),
                                        "Thành công Email", JOptionPane.INFORMATION_MESSAGE);
                            } else {
                                JOptionPane.showMessageDialog(xuathang.this,
                                        "Gửi email hóa đơn thất bại!\nVui lòng kiểm tra cấu hình và kết nối.",
                                        "Lỗi Email", JOptionPane.ERROR_MESSAGE);
                                allAuxiliaryTasksSucceeded = false;
                            }
                        }

                        if (printSelected && allAuxiliaryTasksSucceeded) {
                            boolean printOpSuccess = utils.PrintService.printInvoice(xuatHangListProcessing,
                                    selectedKhachHang);
                            if (printOpSuccess) {
                            } else {
                                allAuxiliaryTasksSucceeded = false;
                        ...
                        if (allAuxiliaryTasksSucceeded) {
                            ...
                            String hinhThucTT = cbHinhThucThanhToan.getSelectedItem() != null
                            ...
                            for (DTO.xuatHangDTO xhItem : xuatHangListProcessing) {
                                ...
                                String maHoaDonMoi = "HD_" + xhItem.getMaPX().replaceAll("[^a-zA-Z0-9]", "") + "_"
                                        + System.nanoTime() % 1000000;
                                while (hoaDonBUS_manager.isMaHoaDonExists(maHoaDonMoi)) {
                                    maHoaDonMoi = "HD_" + xhItem.getMaPX().replaceAll("[^a-zA-Z0-9]", "") + "_"
                                            + System.nanoTime() % 1000000 + (int) (Math.random() * 100);
                                }
                                ...
                                if (addHoaDonSuccess) {
                                    sanPhamDAO_manager.giamSoLuongTonKho(xhItem.getMaSanPham(),
                                            Integer.parseInt(xhItem.getSoLuong()));
                                    savedHoaDonCount++;
                                } else {
                                    conn.rollback();
                                    JOptionPane
                                            .showMessageDialog(xuathang.this,
                                                    "Lỗi khi lưu hóa đơn cho SP: " + xhItem.getTenSanPham()
                                                            + ". Giao dịch hủy.",
                                                    "Lỗi Lưu Hóa Đơn", JOptionPane.ERROR_MESSAGE);
                                    return;
                                }
                            }
                            ...
                            loadXuatHangTable();
                            JOptionPane.showMessageDialog(xuathang.this,
                                    "Hoàn tất xử lý " + xuatHangListProcessing.size() + " mục xuất hàng và lưu "
                                            + savedHoaDonCount + " hóa đơn!",
                                    "Hoàn thành", JOptionPane.INFORMATION_MESSAGE);
                        } else {
                            JOptionPane.showMessageDialog(xuathang.this,
                                    "Do có lỗi/hủy trong quá trình xử lý tùy chọn (PDF/Email/In), các thay đổi chưa được lưu vào CSDL.",
                        ...
                        JOptionPane.showMessageDialog(xuathang.this, "Đã hủy thao tác xuất hàng.", "Thông báo hủy",
                                JOptionPane.INFORMATION_MESSAGE);
                        if (conn != null)
                            conn.rollback();
                    }
                    ...
                    e.printStackTrace();
                    JOptionPane.showMessageDialog(xuathang.this, "Lỗi hệ thống khi xử lý xuất hàng: " + e.getMessage(),
    ...
    private void initComponents() {
        ...
        tblXuatHang.setModel(new javax.swing.table.DefaultTableModel(
                new Object[][] {},
                new String[] {
                        "Mã PX", "Mã KH", "Tên KH", "Mã SP", "Tên SP", "Kích thước", "Màu sắc", "Số lượng", "Đơn giá",
                        "Thành tiền", "Hình thức thanh toán", "Trạng thái"
                }) {
            @Override
        ...
        jPanel7.setBorder(BorderFactory.createTitledBorder(lineBorder7, "Xuất hàng",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 12), AppColors.NEW_MAIN_TEXT_COLOR));
        ...
        jPanel5.setBorder(BorderFactory.createTitledBorder(lineBorder5, "Khách hàng",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 12), AppColors.NEW_MAIN_TEXT_COLOR));
                ...
                jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(lblMaKhachHang)
                                        .addComponent(cbMaKhachHang, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(lblTenKhachHang)
                                        .addComponent(cbTenKhachHang, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel9.setBorder(BorderFactory.createTitledBorder(lineBorder9, "Chi Phí",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 12), AppColors.NEW_MAIN_TEXT_COLOR));
                ...
                jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel9Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addComponent(jTextField8, javax.swing.GroupLayout.DEFAULT_SIZE, 288,
                                                Short.MAX_VALUE))
                                .addContainerGap()));
        jPanel9Layout.setVerticalGroup(
                jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel9Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(jTextField8, javax.swing.GroupLayout.PREFERRED_SIZE, 42,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
                    if (cbMaSanPham.getSelectedItem() == null || jTextField10.getText().trim().isEmpty()
                            || cbMaKhachHang.getSelectedItem() == null) {
                        JOptionPane.showMessageDialog(xuathang.this,
                                "Vui lòng điền đầy đủ thông tin Mã SP, Số Lượng và Khách Hàng!");
                        return;
                    }
                    ...
                    e.printStackTrace();
                    JOptionPane.showMessageDialog(xuathang.this,
                            "Lỗi khi thêm sản phẩm vào phiếu xuất: " + e.getMessage());
                }
            }
        });
        ...
        pblBoxSanPhamSoLuong.setBorder(BorderFactory.createTitledBorder(lineBorderSP, "Sản phẩm & Số lượng",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 12), AppColors.NEW_MAIN_TEXT_COLOR));
        ...
        cbHinhThucThanhToan
                .setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tiền Mặt", "Chuyển Khoản", "Thẻ" }));
        ...
        pblBoxSanPhamSoLuongLayout.setHorizontalGroup(
                pblBoxSanPhamSoLuongLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(pblBoxSanPhamSoLuongLayout.createSequentialGroup()
                                .addGap(28, 28, 28)
                                .addGroup(pblBoxSanPhamSoLuongLayout
                                ...
                                .addGroup(pblBoxSanPhamSoLuongLayout
                                        ...
                                        .addComponent(cbHinhThucThanhToan, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE))
                ...
                pblBoxSanPhamSoLuongLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(pblBoxSanPhamSoLuongLayout.createSequentialGroup()
                                ...
                                .addGroup(pblBoxSanPhamSoLuongLayout
                                        ...
                                        .addComponent(lblMaSanPham)
                                        .addComponent(cbMaSanPham, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(pblBoxSanPhamSoLuongLayout
                                ...
                                .addGroup(pblBoxSanPhamSoLuongLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(lblHinhThucThanhToan)
                                        .addComponent(cbHinhThucThanhToan, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(9, 9, 9)));
                ...
                pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(pnlContentLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlContentLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(jPanel7, javax.swing.GroupLayout.DEFAULT_SIZE, 961,
                                                Short.MAX_VALUE)
                        ...
                        .addGroup(pnlContentLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(textTongTien, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 164,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(28, 28, 28)
                                .addComponent(btnXacNhan, javax.swing.GroupLayout.PREFERRED_SIZE, 205,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(30, 30, 30)));
        pnlContentLayout.setVerticalGroup(
                pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(pnlContentLayout.createSequentialGroup()
                                .addComponent(jPanel7, javax.swing.GroupLayout.PREFERRED_SIZE, 340,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 26,
                                        Short.MAX_VALUE)
                                .addGroup(
                                        pnlContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 46,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(btnXacNhan, javax.swing.GroupLayout.PREFERRED_SIZE, 46,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(lblTongTien, javax.swing.GroupLayout.PREFERRED_SIZE, 46,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(textTongTien, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(20, 20, 20)));
    ...
    private void setupUI() {
        ...
        // These are now set directly in initComponents or through
        // GroupLayout/AbsoluteLayout of jPanel7
        // jPanel7.setPreferredSize(new java.awt.Dimension(960, 317)); // Old value, new
        // one is 340
        // jScrollPane1.setPreferredSize(new java.awt.Dimension(960, 190)); // Old
        // value, new one is 192
    }
    ...
    private void loadComboBoxData() {
        ...
        if (!codes.isEmpty())
            cbMaSanPham.setSelectedIndex(0); // Select first item if available
    }
