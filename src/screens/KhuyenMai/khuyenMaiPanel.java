                ...
                jButton33.addActionListener(e -> {
                        ...
                        if (confirm == JOptionPane.YES_OPTION) {
                                ...
                                try {
                                        ...
                                        if (success) {
                                                JOptionPane.showMessageDialog(khuyenMaiPanel.this, "Xóa thành công!");
                                                loadKhuyenMaiData();
                                        } else {
                                                JOptionPane.showMessageDialog(khuyenMaiPanel.this, "Xóa thất bại!");
                                        }
                                } catch (Exception ex) {
                                        JOptionPane.showMessageDialog(khuyenMaiPanel.this, ex.getMessage(), "Lỗi",
